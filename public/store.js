...
var stripeHandler = StripeCheckout.configure({
    ...
    token: function(token) {
        ...
        fetch("/purchase", {
            ...
            body: JSON.stringify({
                stripeTokenId: token.id, // Where is id from? I only see idea of the items in the token. is this the ID that was generated by the API once user enters credit card information?
                items: items
            }).then(function(res) {
                return res.json();
            }).then(function(data) {
...
function addToCartClicked(event) {
    ...
    var id = shopItem.dataset.itemId; // Why not just use getElementByClassName? Is it because it is an id, and not class name?
